...
import { RESTUARANT_DISH_IMAGE_URL, RESTUARANT_IMAGE_URL } from "../../Utils/API_KEYS";
        ...
        <div className="res-menu-container">
            <div className="res-menu-header">
                ...
                <div className="res-menu-header-img">
                    <img src={RESTUARANT_IMAGE_URL + cloudinaryImageId} alt={name} />
                </div>
            </div>
                                ...
                                {itemCards.map(item => (
                                    <li key={item.card.info.id} className="menu-item-card">
                                        ...
                                        <div className="menu-item-img-container">
                                            <img src={RESTUARANT_DISH_IMAGE_URL + item.card.info.imageId} alt={item.card.info.name} className="item-img" />
                                        </div>
                                    </li>
                                ))}
                            </ul>
